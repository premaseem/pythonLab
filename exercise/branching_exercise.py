...
print("verified") if account is "verified" and payment_status is "paid" else print("Access denied")
...
print("verified") if account == "verified" and payment_status == "paid" else print("Temporary access granted, check payment status") if account == "verified" and payment_status == "pending" else print("Access denied, check payment")
