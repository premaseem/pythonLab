...
## Write your code below, 1 line ##
arr = [bright_idea, result]
joiner = ", "
newStr = joiner.join(arr)
#print(newStr)
...
## Write your code below, 1 line ##
print("Is this equal?", word_to_test == word_to_test[-1::-1])
...
start_index = len(my_daily_thought) // 2
print(my_daily_thought[start_index:])
